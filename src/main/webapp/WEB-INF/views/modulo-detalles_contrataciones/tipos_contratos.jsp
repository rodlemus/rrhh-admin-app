        ...
        <div class="w-full mt-2 bg-gray-200">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="cargos" data-bs-toggle="tab" data-bs-target="#cargos-tab-pane" type="button" role="tab" aria-controls="cargos-tab-pane" aria-selected="true" onclick="window.location.href='${contextPath}/router-app?modulo=propiedades'">Cargos Disponibles</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="Tcontrato-tab" data-bs-toggle="tab" data-bs-target="#Tcontrato-tab-pane" type="button" role="tab" aria-controls="Tcontrato-tab-pane" aria-selected="false">Tipos de Contrato</button>
                </li>
                <li class="nav-item" role="presentation">
                        ...
                        <c:forEach items="${tiposC}" var="tipoC">
                            <tr class="text-center">
                                ...
                                <td class="d-flex justify-content-center align-items-center gap-2">
                                    <button class="btn btn-warning btn-editar" type="button" data-bs-toggle="modal" data-bs-target="#modalEditarCargo" data-id="${tipoC.getIdTipoC()}" data-tipoc="${tipoC.getTipoC()}">
                                        <svg xmlns="http://www.w3.org/2000/svg" height="30px" viewBox="0 -960 960 960" width="30px" fill="#fff">
                                            <path d="M200-200h57l391-391-57-57-391 391v57Zm-80 80v-170l528-527q12-11 26.5-17t30.5-6q16 0 31 6t26 18l55 56q12 11 17.5 26t5.5 30q0 16-5.5 30.5T817-647L290-120H120Zm640-584-56-56 56 56Zm-141 85-28-29 57 57-29-28Z"/>
                                        </svg>
                                    </button>
                                    <button class="btn btn-danger btn-eliminar" type="button" data-bs-toggle="modal" data-bs-target="#modalEliminarCargo" data-id="${tipoC.getIdTipoC()}" data-cargo="${tipoC.getTipoC()}">
                                        <svg xmlns="http://www.w3.org/2000/svg" height="30px" viewBox="0 -960 960 960" width="30px" fill="#fff">
